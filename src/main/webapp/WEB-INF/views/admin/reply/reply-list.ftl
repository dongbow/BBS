	                        	...
	                        	<#if replys??>
	                        		<#list replys as reply>
	                        			<tr>
				                            ...
				                            <td class="numeric" data-title="更新人">
				                            	<#if reply.replyUpdateUser??>
				                            		<a href="${path}/space/uid/${reply.replyUpdateUserId}" target="_blank" style="color:#428bca">${reply.replyUpdateUser}</a>
				                            	</#if>
				                            </td>
				                            <td class="numeric" data-title="更新时间">
				                            	<#if reply.replyUpdateUser??>${reply.replyUpdateTime}</#if>
				                            </td>
				                            ...
				                            <td class="numeric" data-title="查看更多">
				                            	...
				                            	<#if reply.reply??>
				                            		<a class="btn btn-link btn-xs reply-p-content" type="button" data-value="${reply.reply.replyContent}">预览父评论</a>
				                            	</#if>
				                            </td>
